        ...
        {isEditing ? (
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm text-blue-500">
              Public URL: <a href={`https://video-vault-umber.vercel.app/public/${video._id}`} className="underline" target="_blank" rel="noreferrer">
              https://video-vault-umber.vercel.app/public/{video._id}
              </a>
            </p>
